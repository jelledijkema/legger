...
<qgis version="2.18.27" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="geselecteerd_op">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="geselecteerde_diepte">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="geselecteerd_waterbreedte">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="geselecteerde_bodembreedte">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="geselecteerd_talud">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="verhang">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    ...
    <edittype widgetv2type="TextEdit" name="overdiepte">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="overbreedte_links">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="overbreedte_rechts">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  </edittypes>
  <renderer-v2 attr="to_real( &quot;geselecteerde_diepte&quot; )" forceraster="0" symbollevels="0" type="graduatedSymbol" graduatedMethod="GraduatedColor" enableorderby="0">
    <ranges>
      <range render="true" symbol="0" lower="0.000000000000000" upper="0.100000000000000" label=" 0.00 - 0.10 "/>
      <range render="true" symbol="1" lower="0.100000000000000" upper="0.250000000000000" label=" 0.10 - 0.25 "/>
      <range render="true" symbol="2" lower="0.250000000000000" upper="0.500000000000000" label=" 0.25 - 0.50 "/>
      <range render="true" symbol="3" lower="0.500000000000000" upper="1.000000000000000" label=" 0.50 - 1.00 "/>
      <range render="true" symbol="4" lower="1.000000000000000" upper="1.500000000000000" label=" 1.00 - 1.50 "/>
      <range render="true" symbol="5" lower="1.500000000000000" upper="10.000000000000000" label=" 1.50 - 10.00 "/>
    </ranges>
    <symbols>
      ...
      <symbol alpha="1" clip_to_extent="1" type="line" name="1">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="66,10,104,255"/>
          <prop k="line_style" v="solid"/>
          <prop k="line_width" v="0.86"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="0"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="line" name="2">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="147,37,103,255"/>
          <prop k="line_style" v="solid"/>
          <prop k="line_width" v="0.86"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="0"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="line" name="3">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="221,80,57,255"/>
          <prop k="line_style" v="solid"/>
          <prop k="line_width" v="0.86"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="0"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="line" name="4">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="252,164,11,255"/>
          <prop k="line_style" v="solid"/>
          <prop k="line_width" v="0.86"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="0"/>
  ...
  <customproperties>
    ...
    <property key="labeling/bufferColorB" value="219"/>
    <property key="labeling/bufferColorG" value="247"/>
    ...
    <property key="labeling/fieldName" value="'diepte: ' || round(to_real( &quot;geselecteerde_diepte&quot; ),2) || ' m'"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="geselecteerd_waterbreedte"/>
      <column width="-1" hidden="0" type="field" name="geselecteerde_bodembreedte"/>
      <column width="-1" hidden="0" type="field" name="geselecteerd_talud"/>
      <column width="-1" hidden="0" type="field" name="verhang"/>
      <column width="-1" hidden="0" type="field" name="profiel_opmerking"/>
      <column width="-1" hidden="0" type="field" name="fit_score"/>
      <column width="-1" hidden="0" type="field" name="offset"/>
      <column width="-1" hidden="0" type="field" name="overdiepte"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="geselecteerd_op" expression=""/>
    <default field="geselecteerde_diepte" expression=""/>
    <default field="geselecteerd_waterbreedte" expression=""/>
    <default field="geselecteerde_bodembreedte" expression=""/>
    ...
    <default field="overbreedte_links" expression=""/>
    <default field="overbreedte_rechts" expression=""/>
  </defaults>
