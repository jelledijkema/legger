...
<qgis version="2.18.16" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="vertex_id">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  </edittypes>
  <renderer-v2 attr="typ" forceraster="0" symbollevels="0" type="categorizedSymbol" enableorderby="0">
    <categories>
      <category render="true" symbol="0" value="end" label="end"/>
      <category render="true" symbol="1" value="target" label="target"/>
  ...
  <aliases>
    ...
    <alias field="hydro_id" index="1" name=""/>
    <alias field="typ" index="2" name=""/>
    <alias field="vertex_id" index="3" name=""/>
  </aliases>
  <excludeAttributesWMS/>
  <excludeAttributesWFS/>
  <attributeactions default="-1"/>
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="1157006784">
    <columns>
      <column width="-1" hidden="0" type="field" name="id"/>
      <column width="-1" hidden="0" type="field" name="hydro_id"/>
      <column width="-1" hidden="0" type="field" name="typ"/>
      <column width="-1" hidden="0" type="field" name="vertex_id"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="vertex_id" expression=""/>
  </defaults>
