...
<qgis styleCategories="Symbology|Labeling|Legend" version="3.16.3-Hannover" labelsEnabled="0">
  <renderer-v2 enableorderby="0" forceraster="0" symbollevels="0" graduatedMethod="GraduatedColor" type="graduatedSymbol" attr="org_wb">
    <ranges>
      <range upper="-0.500000000000000" symbol="0" label="&lt; -0.5: er 'verdwijnt' water" lower="-inf" render="true"/>
      <range upper="-0.010000000000000" symbol="1" label="-0.5 - -0.01" lower="-0.500000000000000" render="true"/>
      <range upper="-0.000001000000000" symbol="2" label="-0.01 - -0.000001" lower="-0.010000000000000" render="true"/>
      <range upper="0.000001000000000" symbol="3" label="-0.000001 - 0.000001" lower="-0.000001000000000" render="false"/>
      <range upper="0.010000000000000" symbol="4" label="0.000001 - 0.01" lower="0.000001000000000" render="true"/>
      <range upper="0.500000000000000" symbol="5" label="0.01 - 0.5" lower="0.010000000000000" render="true"/>
      <range upper="inf" symbol="6" label="> 0.5: er komt water bij" lower="0.500000000000000" render="true"/>
    </ranges>
    <symbols>
