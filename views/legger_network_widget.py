...
from PyQt4.QtGui import (QApplication, QComboBox, QDockWidget, QHBoxLayout, QPlainTextEdit, QPushButton, QSizePolicy,
                         QSpacerItem, QTabWidget, QVBoxLayout, QWidget, QGroupBox, QLabel)
