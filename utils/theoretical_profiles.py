...
def create_theoretical_profiles(legger_db_filepath):
    ...
    hydro_objects_satisfy = profile_max_ditch_width[profile_max_ditch_width['gradient_bos_bijkerke'] <= gradient_norm]
    hydro_objects_unsatisfy = profile_max_ditch_width[profile_max_ditch_width['gradient_bos_bijkerke'] > gradient_norm]
...
def write_theoretical_profile_results_to_db(profile_results, path_legger_db):
    ...
    for i, rows in profile_results.iterrows():
        if profile_results.gradient_bos_bijkerke[i] > gradient_norm:
