...
def prof_in_prof(profgem, proftheo, aantstap=100, delta=0.001, obdiepte=0.0, debug=0):
...
def doe_profinprof(cur0, cur1, aantalstappen=200, precisie=0.0001, codevastebodem="Z1", peilcriterium="min",
                           projectiecriterium="eindpunt", obdiepte=0.0, debug=0):
    """
...
# obdiepte = 0.0  # de diepte waarop de overbreedte bepaald moet worden
